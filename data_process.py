...
def arff2npy(dataset_name, label_count, split=True):
    ...
    if split:
        train_file_path = './dataset/dataset_original/' + dataset_name + '/' + dataset_name + '-train.arff'
        test_file_path = './dataset/dataset_original/' + dataset_name + '/' + dataset_name + '-test.arff'
        ...
        file_path = './dataset/dataset_original/' + dataset_name + '/' + dataset_name + '.arff'
